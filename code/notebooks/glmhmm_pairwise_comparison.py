...
def _(get_adapter, mo, paths, pl, ui_task):
    ...
    return adapter, df_all, ui_scoring_key, ui_subjects
...
@app.cell
def _(mo, ui_alias_a, ui_alias_b, ui_pairwise_K, ui_scoring_key, ui_subjects, ui_task):
    mo.vstack(
        [
...
@app.cell
def _(pairwise_alias_a, pairwise_alias_b, pairwise_metrics_a, pairwise_metrics_b, pl):
    ...
    return pairwise_metric_deltas, pairwise_metric_summary


@app.cell
def _(mo, pairwise_metric_deltas, pairwise_metric_summary):
    mo.vstack(
        [
...
def _(
    ...
    return pairwise_occupancy_summary, pairwise_subject_occupancy


@app.cell
def _(pairwise_alias_a, pairwise_alias_b, pairwise_trial_df_a, pairwise_trial_df_b, pl):
    schema = {
        "subject": pl.Utf8,
        "model_alias": pl.Utf8,
        "state_label": pl.Utf8,
    ...
    return pairwise_accuracy_summary, pairwise_subject_accuracy
...
@app.cell
def _(mo, pairwise_K, pairwise_alias_a, pairwise_alias_b, pairwise_subject_occupancy, plot_paired_category_boxplot):
    ...
    mo.vstack([mo.md("### Occupancy"), occ_fig])
    return


@app.cell
def _(mo, pairwise_accuracy_summary, pairwise_alias_a, pairwise_alias_b, pairwise_subject_accuracy, plot_paired_category_boxplot, pairwise_adapter_a):
    ...
    mo.vstack([mo.md("### Accuracy"), acc_fig, pairwise_accuracy_summary])
    return


@app.cell
def _(mo, pairwise_alias_a, pairwise_alias_b, pairwise_metric_deltas, plot_paired_metric_boxplot):
